...
//   • 15 selling SKUs  • 4 pre-launch NPIs  • 5 Distributors  • 3 Regions
...
export const DISTRIBUTORS = [
  { id: 'DST-001', name: 'boAt North Distribution Hub', region: 'North', tier: 'A' },
  { id: 'DST-002', name: 'Western India Audio Channel Partners', region: 'West', tier: 'A' },
  { id: 'DST-003', name: 'Northland Electronics Distributors', region: 'North', tier: 'B' },
  { id: 'DST-004', name: 'South India Digital Retail Network', region: 'South', tier: 'A' },
  { id: 'DST-005', name: 'West Bharat Consumer Electronics Traders', region: 'West', tier: 'C' },
]
...
export const EVENT_TEMPLATES = [
  ...
  ['EVT-TPL-SUMMER', 'Summer Audio Days', 'TRADE_CAMPAIGN', 'FREQ=YEARLY;BYMONTH=4', 2, 0.12, 'FLAT', 'SEASONAL', 0.3],
...
const EVENT_SEEDS = [
  { eventId: 'EVT-2026-REPUBLIC', eventTemplateId: 'EVT-TPL-REPUBLIC', eventName: 'Republic Day Audio Sale 2026', startWeek: '2026-W04', endWeek: '2026-W05', categories: [], affectedSkus: [], affectedChannels: [], regionIds: [], upliftPct: 0.18, priceDiscountRate: 0.08 },
  { eventId: 'EVT-2026-SUMMER', eventTemplateId: 'EVT-TPL-SUMMER', eventName: 'Summer Audio Days 2026', startWeek: '2026-W16', endWeek: '2026-W18', categories: ['TWS Earbuds', 'Neckbands', 'Portable Speakers'], affectedSkus: [], affectedChannels: [], regionIds: [], upliftPct: 0.12, priceDiscountRate: 0.05 },
  { eventId: 'EVT-2026-PRIME', eventTemplateId: 'EVT-TPL-PRIME', eventName: 'E-commerce Prime Days 2026', startWeek: '2026-W29', endWeek: '2026-W30', categories: [], affectedSkus: ['SKU-BOAT-AD141', 'SKU-BOAT-AD161P', 'SKU-BOAT-WC100'], affectedChannels: ['DST-002', 'DST-004'], regionIds: [], upliftPct: 0.24, priceDiscountRate: 0.1 },
    ...
    for (const dist of DISTRIBUTORS) {
      ...
      weeks.forEach((w, idx) => {
        ...
        const tertiary = Math.max(0, Math.round(
          sku.baseWeekly * DIST_FACTOR[dist.id] * seas * trend * (1 + event.realizedUpliftRate) * noise
        ))
