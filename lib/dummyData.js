// =======================================================================
// S&OP Demo – Central Dummy Data Module (MTR-style branded foods)
// -----------------------------------------------------------------------
...
const toInrListPrice = (usdSized) => round(usdSized * DEMO_INR_PER_USD, 2)
...
export const SKUS = [
  { id: 'SKU-10842', name: 'MTR Rava Idli Mix (Signature product)', category: 'Breakfast Mixes (Instant)', price: toInrListPrice(1.49), cost: toInrListPrice(0.62), baseWeekly: 4200, seasonPeakWeek: 28, seasonAmp: 0.35, growth: 0.004 },
  { id: 'SKU-10843', name: 'MTR Rice Idli Mix',                     category: 'Breakfast Mixes (Instant)', price: toInrListPrice(0.99), cost: toInrListPrice(0.38), baseWeekly: 5800, seasonPeakWeek: 30, seasonAmp: 0.30, growth: 0.002 },
  { id: 'SKU-10844', name: 'MTR Instant Dosa Mix',                  category: 'Breakfast Mixes (Instant)', price: toInrListPrice(3.99), cost: toInrListPrice(1.70), baseWeekly: 1200, seasonPeakWeek: 26, seasonAmp: 0.40, growth: 0.010 },
  { id: 'SKU-10845', name: 'MTR Rava Dosa Mix',                     category: 'Breakfast Mixes (Instant)', price: toInrListPrice(1.79), cost: toInrListPrice(0.70), baseWeekly: 2600, seasonPeakWeek: 30, seasonAmp: 0.45, growth: 0.005 },
  { id: 'SKU-20591', name: 'MTR Paneer Butter Masala',              category: 'Ready-To-Eat (RTE) Meals',  price: toInrListPrice(4.49), cost: toInrListPrice(1.90), baseWeekly: 1800, seasonPeakWeek: 48, seasonAmp: 0.25, growth: 0.006 },
  { id: 'SKU-20592', name: 'MTR Dal Makhani',                       category: 'Ready-To-Eat (RTE) Meals',  price: toInrListPrice(2.29), cost: toInrListPrice(0.92), baseWeekly: 2400, seasonPeakWeek: 51, seasonAmp: 0.30, growth: 0.003 },
  { id: 'SKU-20593', name: 'MTR Chana Masala',                      category: 'Ready-To-Eat (RTE) Meals',  price: toInrListPrice(5.49), cost: toInrListPrice(2.40), baseWeekly: 1100, seasonPeakWeek: 51, seasonAmp: 0.35, growth: 0.008 },
  { id: 'SKU-30220', name: 'MTR Sambar Powder',                     category: 'Spices and Masalas',        price: toInrListPrice(4.99), cost: toInrListPrice(2.20), baseWeekly: 2200, seasonPeakWeek: 10, seasonAmp: 0.15, growth: -0.001 },
  { id: 'SKU-30221', name: 'MTR Spicy Sambar Powder',               category: 'Spices and Masalas',        price: toInrListPrice(3.29), cost: toInrListPrice(1.60), baseWeekly: 3100, seasonPeakWeek: 2,  seasonAmp: 0.12, growth: 0.001 },
  { id: 'SKU-30222', name: 'MTR Rasam Powder',                      category: 'Spices and Masalas',        price: toInrListPrice(6.49), cost: toInrListPrice(2.95), baseWeekly: 900,  seasonPeakWeek: 50, seasonAmp: 0.28, growth: 0.004 },
  { id: 'SKU-40117', name: 'MTR 3 Minute Poha',                     category: 'Rice and Poha Items',       price: toInrListPrice(5.99), cost: toInrListPrice(2.60), baseWeekly: 1400, seasonPeakWeek: 26, seasonAmp: 0.30, growth: 0.005 },
  { id: 'SKU-40118', name: 'MTR Ready-to-Eat Vegetable Pulao',      category: 'Rice and Poha Items',       price: toInrListPrice(4.79), cost: toInrListPrice(2.00), baseWeekly: 1700, seasonPeakWeek: 30, seasonAmp: 0.50, growth: 0.003 },
  { id: 'SKU-40119', name: 'MTR Ready-to-Eat Sambar Rice',          category: 'Rice and Poha Items',       price: toInrListPrice(4.29), cost: toInrListPrice(1.80), baseWeekly: 1500, seasonPeakWeek: 4,  seasonAmp: 0.25, growth: 0.002 },
  { id: 'SKU-50803', name: 'MTR Mixed Vegetable Pickle',            category: 'Pickles and Snacks',        price: toInrListPrice(3.99), cost: toInrListPrice(1.50), baseWeekly: 1300, seasonPeakWeek: 20, seasonAmp: 0.10, growth: 0.003 },
  { id: 'SKU-50804', name: 'MTR Mango Sliced Pickle',               category: 'Pickles and Snacks',        price: toInrListPrice(5.29), cost: toInrListPrice(2.10), baseWeekly: 1000, seasonPeakWeek: 15, seasonAmp: 0.10, growth: 0.004 },
]
    ...
    for (const dist of DISTRIBUTORS) {
      ...
      weeks.forEach((w, idx) => {
        ...
        const tertiary = Math.max(0, Math.round(
          sku.baseWeekly * DIST_FACTOR[dist.id] * seas * trend * noise / 4
        ))
...
export function suggestOrders(distributorId) {
  ...
  for (const [skuId, rows] of bySku.entries()) {
    ...
    let scheme = null
    if (sku.category === 'Breakfast Mixes (Instant)' && last.weekNumber >= 24 && last.weekNumber <= 34) {
      scheme = { label: 'Buy 10 Get 1 Free', discountPct: 9 }
    } else if (sku.category === 'Ready-To-Eat (RTE) Meals' && last.weekNumber >= 45) {
      scheme = { label: 'Holiday bundle 5% off', discountPct: 5 }
    } else if (sku.category === 'Rice and Poha Items' && isHighDemand) {
      scheme = { label: 'Volume rebate 3%', discountPct: 3 }
